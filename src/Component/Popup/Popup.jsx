    ...
    return(
        <div className={`flex items-center justify-center position: absolute top-32 z-30 w-full ${popupStatus?'show-popup':'unshow-popup'}`}>
            <div className="rounded-3xl px-5 py-10 flex bg-gray-200 shadow-xl shadow-slate-500 w-[90%] sm:w-3/4 lg:w-1/2 xl:w-1/3 2xl:w-2/5 position: relative">
                ...
                <h1 className="font-bold text-xl text-slate-600 2xl:text-6xl 2xl:mt-10 ">Sign Up Successful!</h1>
                <p className="w-11/12 text-md my-3 text-slate-500 2xl:text-4xl 2xl:mt-10">You are already a member of our family</p>
                <button className="shadow-md shadow-slate-400 font-bold px-8 py-2 2xl:text-4xl 2xl:py-5 2xl:px-12 2xl:mt-10 2xl:mb-10 bg-purple rounded-xl text-white text-lg cursor-pointer hover:bg-white hover:text-purple duration-700 border-purple border-2">Continues </button>
                </div>
            </div>
        </div>
    )
